...
public class ServeurBis 
{
	...
	public static void connection(String[] args)
	{
		...
		ServeurBis srvSns = null; // instance de la classe principale pour permettre plusieurs instances
		ServerSocket ss = null; // ouverture du serveur sur un port ad�quate
	    try
	    {
	    	srvSns = new ServeurBis(); 
	    	...
	    	{
	    		new ClientThread2(ss.accept(),srvSns); // un client se connecte, un nouveau thread client est lanc�
	    	}
	    }
	    catch (Exception e) 
	    {
